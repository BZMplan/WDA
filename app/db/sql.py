...
from app.core.config import load_postgresql_config
...
def create_sensorlog_table(table_name: str):
    """
    创建设备定位日志表
    ...
    columns = [
        Column("id", Integer, primary_key=True, autoincrement=True),
        Column("device_name", String(64), nullable=False),
        Column("server_timestamp", Integer, nullable=False),
        Column("device_timestamp", Integer, nullable=True),
        Column("time_utc", DateTime, nullable=False),
        Column("time_local", DateTime, nullable=False),
        Column("altitude", Float, nullable=True),
        Column("latitude", Float, nullable=True),
        Column("longitude", Float, nullable=True),
        Column("horizontal_accuracy", Float, nullable=True),
